...
cis_$(FLASH_TYPE)__script:
	...
	@echo $(FLASH_WRITE) $(TFTPDOWNLOADADDR) 0x00000 \$${filesize} >> $(SCRIPTDIR)/[[cis.es
	@echo $(FLASH_WRITE) $(TFTPDOWNLOADADDR) 0x20000 \$${filesize} >> $(SCRIPTDIR)/[[cis.es
	@echo $(FLASH_WRITE) $(TFTPDOWNLOADADDR) 0x40000 \$${filesize} >> $(SCRIPTDIR)/[[cis.es
	@echo $(FLASH_WRITE) $(TFTPDOWNLOADADDR) 0x60000 \$${filesize} >> $(SCRIPTDIR)/[[cis.es
	@echo $(FLASH_WRITE) $(TFTPDOWNLOADADDR) 0x80000 \$${filesize} >> $(SCRIPTDIR)/[[cis.es
	@echo $(FLASH_WRITE) $(TFTPDOWNLOADADDR) 0xA0000 \$${filesize} >> $(SCRIPTDIR)/[[cis.es
	@echo $(FLASH_WRITE) $(TFTPDOWNLOADADDR) 0xC0000 \$${filesize} >> $(SCRIPTDIR)/[[cis.es
	@echo $(FLASH_WRITE) $(TFTPDOWNLOADADDR) 0xE0000 \$${filesize} >> $(SCRIPTDIR)/[[cis.es
	@echo $(FLASH_WRITE) $(TFTPDOWNLOADADDR) 0x100000 \$${filesize} >> $(SCRIPTDIR)/[[cis.es
	@echo $(FLASH_WRITE) $(TFTPDOWNLOADADDR) 0x120000 \$${filesize} >> $(SCRIPTDIR)/[[cis.es
