...
static void __iomem *resume_imi_vbase;
static void __iomem *resume_imistack_vbase;
...
static int mstar_suspend_ready(unsigned long ret)
{
    ...
    *(unsigned short volatile *) 0xFD200800 = 0x2222;
    ...
    mstar_resume_imi_fn = fncpy(resume_imi_vbase, (void*)&sram_resume_imi, 0x400);

    resume_fn=(u32)mstar_resume_imi_fn;
    stack=(u32)resume_imistack_vbase+0x400;
...
int __init mstar_pm_init(void)
{
    ...
    resume_imi_vbase = __arm_ioremap_exec(0xA0002000, 0x400, false);  //put suspend code at IMI offset 64K;
...
//    resume_imistack_vbase = __arm_ioremap_exec(0xA0007000, 0x1100, false);  //put stack at IMI 0xA0008000
    resume_imistack_vbase = suspend_imi_vbase;
    ...
    printk("!!!!!!!!![%s] resume_pbase=0x%08X, suspend_imi_vbase=0x%08X\n", __func__, (unsigned int)resume_imistack_vbase, (unsigned int)suspend_imi_vbase);
