...
MI_S32 ST_BaseModuleInit(ST_Config_S* pstConfig)
{
    ...
    *************************************************/
    ...
    if ((g_device_num==1) &&
        ((g_stStreamAttr[USB_CAMERA0_INDEX].eBindType == E_MI_SYS_BIND_TYPE_HW_RING) ||
        (g_stStreamAttr[USB_CAMERA0_INDEX].eBindType == E_MI_SYS_BIND_TYPE_REALTIME)))
    {
        eVifWorkMode = E_MI_VIF_WORK_MODE_RGB_REALTIME;
    } else {
        eVifWorkMode = E_MI_VIF_WORK_MODE_RGB_FRAMEMODE;
        g_stStreamAttr[USB_CAMERA0_INDEX].eBindType = E_MI_SYS_BIND_TYPE_FRAME_BASE;
    }
