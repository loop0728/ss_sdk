...
late_mount: app
	...
	if [ "$(FWFS_MOUNT_BLK)" != "" ]; then \
		...
		mkdir -p $(OUTPUTDIR)/rootfs/misc;\
		$(foreach block, $(FWFS_MOUNT_BLK), $(PROJ_ROOT)/image/makefiletools/script/fwfs_mount.py --flash_type=$(FLASH_TYPE) --part_size=$($(block)$(PATSIZE)) --rcs_dir=$(INIT_FILE) $($(block)$(MOUNTPT)) $($(block)$(MOUNTTG));)\
	fi;
