...
extern "C" {
	...
	namespace CodeDeCode {
		...
		*输入： width图像宽
		*输入： height图像高度
		*输入： imgformat图像格式参考ImageFormats，注意P3和i6e硬件的ARGB8888对应的是BGRX
		*输入： codeformat二维码指定格式比如QR_CODE，不指定就选择为所有格式   所有支持格式{AZTEC,CODABAR,CODE_39,CODE_93,CODE_128,DATA_MATRIX,EAN_8,EAN_13,ITF,MAXICODE,PDF_417,QR_CODE,RSS_14,RSS_EXPANDED,UPC_AUPC_E}
