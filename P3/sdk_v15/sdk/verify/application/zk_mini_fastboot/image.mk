...
ifeq ($(IMAGE_INSTALL_DIR),)
	...
	@cp -rfd $(APPLICATION_PATH)/zk_mini_fastboot/RunFiles/lib/RunFirst/lib $(IMAGE_INSTALL_DIR)/rootfs/customer_app/
	@cp -rfd $(APPLICATION_PATH)/zk_mini_fastboot/RunFiles/lib/RunFirst/libsecurity $(IMAGE_INSTALL_DIR)/rootfs/customer_app/
	@$(STRIP) --strip-unneeded $(IMAGE_INSTALL_DIR)/rootfs/customer_app/lib/*
	@cp -rfd $(APPLICATION_PATH)/zk_mini_fastboot/RunFiles/lib/RunLater/lib $(IMAGE_INSTALL_DIR)/customer/lib
	...
	@cp  $(APPLICATION_PATH)/zk_mini_fastboot/RunFiles/run_later.sh $(IMAGE_INSTALL_DIR)/customer/
