...
ifeq ($(IMAGE_INSTALL_DIR),)
	...
	@cp -rfd $(APPLICATION_PATH)/zk_full/lib $(IMAGE_INSTALL_DIR)/customer
	@cp -rf $(APPLICATION_PATH)/zk_full/libsecurity $(IMAGE_INSTALL_DIR)/customer
	...
	@cp -rf $(APPLICATION_PATH)/zk_full/bin/zkgui $(IMAGE_INSTALL_DIR)/customer/zkgui
